    ...
    setWorkOrders([
      {
        ...
        location: '第1工場 A棟',
        description: '冷却液ポンプから異音が発生。振動も確認されるため、ポンプの点検および必要に応じて交換作業をお願いします。',
        priority: 'urgent',
        status: 'in-progress',
        assignee: '田中 太郎',
        reporter: '山田 一郎',
      ...
      },
      {
        ...
        equipment: 'プレス機 #7',
        location: '第2工場 B棟',
        description: '油圧シリンダーの定期点検を実施してください。オイル漏れの確認と圧力測定も含む。',
        priority: 'normal',
        status: 'pending',
        assignee: '佐藤 花子',
        reporter: '高橋 次郎',
    ...
    <MainLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-2">作業指示管理</h2>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-3">
                        <h3 className="text-lg font-semibold text-gray-900 mr-4">{order.equipment}</h3>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-500">
                        ...
                        <div className="flex items-center">
                          ...
                          <span>期限: {new Date(order.dueDate).toLocaleDateString('ja-JP', {
                            month: 'short',
                            day: 'numeric',
                            hour: '2-digit',
                            minute: '2-digit'
        ...
        {filteredAndSortedOrders.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">作業指示が見つかりません</h3>
            <p className="text-gray-600">検索条件を変更するか、新しい作業指示を作成してください。</p>
            <Link href="/work-orders/new">
