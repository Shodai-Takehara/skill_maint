    ...
    <MainLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">製造設備の保守状況とチームパフォーマンスの概要</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="bg-white shadow-sm border border-gray-200">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">総設備数</p>
          ...
          <Card className="bg-white shadow-sm border border-gray-200">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">アクティブ作業指示</p>
          ...
          <Card className="bg-white shadow-sm border border-gray-200">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">保守完了率</p>
          ...
          <Card className="bg-white shadow-sm border border-gray-200">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">チームスキルカバレッジ</p>
                  ...
                  <div key={order.id} className="p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900 mb-1">{order.equipment}</h4>
                        <p className="text-sm text-gray-600 mb-2">{order.description}</p>
                        <p className="text-xs text-gray-500">担当: {order.assignee}</p>
                      </div>
                ...
                {maintenanceSchedule.map((item) => (
                  <div key={item.id} className="p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900 mb-1">{item.equipment}</h4>
                        <p className="text-sm text-gray-600 mb-2">{item.type}</p>
                        <p className="text-xs text-gray-500">担当: {item.technician}</p>
                      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/work-orders/new">
              <Button className="w-full h-20 bg-blue-600 hover:bg-blue-700 text-white flex flex-col items-center justify-center space-y-2">
                ...
                <span className="text-sm font-medium">新規作業指示</span>
              </Button>
            </Link>
            ...
            <Link href="/equipment">
              <Button className="w-full h-20 bg-purple-600 hover:bg-purple-700 text-white flex flex-col items-center justify-center space-y-2">
                ...
                <span className="text-sm font-medium">設備一覧</span>
              </Button>
            </Link>
            <Link href="/team">
              <Button className="w-full h-20 bg-orange-600 hover:bg-orange-700 text-white flex flex-col items-center justify-center space-y-2">
