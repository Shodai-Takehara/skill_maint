...
export function LineSelector({ selectedLineId, onLineSelect }: LineSelectorProps) {
        ...
        children: [
          {
            ...
            parentId: 'factory-1',
            children: [
              { id: 'section-1-1-1', name: 'CNC加工セクション', type: 'section', parentId: 'line-1-1' },
              { id: 'section-1-1-2', name: '組立セクション', type: 'section', parentId: 'line-1-1' }
            ]
          },
          {
            id: 'line-1-2',
            ...
            parentId: 'factory-1',
            children: [
              { id: 'section-1-2-1', name: '溶接セクション', type: 'section', parentId: 'line-1-2' },
              { id: 'section-1-2-2', name: '検査セクション', type: 'section', parentId: 'line-1-2' }
            ]
          },
          {
            id: 'line-1-3',
        ...
        children: [
          {
            ...
            parentId: 'factory-2',
            children: [
              { id: 'section-2-1-1', name: 'プレス加工セクション', type: 'section', parentId: 'line-2-1' },
              { id: 'section-2-1-2', name: '仕上げセクション', type: 'section', parentId: 'line-2-1' }
            ]
          },
          {
            id: 'line-2-2',
            ...
            parentId: 'factory-2',
            children: [
              { id: 'section-2-2-1', name: 'ロボットセクション', type: 'section', parentId: 'line-2-2' }
            ]
          }
        ]
      },
  ...
  useEffect(() => {
    if (selectedLineId && organizationData.length > 0) {
      const findLine = (nodes: OrganizationNode[]): { id: string; name: string } | null => {
    ...
    return (
      <div key={node.id}>
        ...
        >
          ...
          {node.type === 'factory' && <Factory className="h-4 w-4 text-gray-700" />}
          {node.type === 'line' && <MapPin className="h-4 w-4 text-gray-900" />}
          {node.type === 'section' && <Settings className="h-4 w-4 text-gray-600" />}
            ...
            <CardContent className="p-0">
              <div className="p-4 border-b border-gray-200/50 lg:hidden">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-bold text-gray-900">ライン選択</h3>
                  <Button variant="ghost" size="sm" onClick={() => setIsOpen(false)} className="rounded-xl">
                    ×
                  </Button>
                </div>
              </div>
