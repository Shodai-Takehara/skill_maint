...
import { Bell, X, Clock, AlertTriangle, CheckCircle, Info, Trash2, BookmarkCheck as MarkAsRead } from 'lucide-react';
    ...
    setNotifications([
      {
        id: 'notif-001',
        title: '緊急: 設備故障',
        message: 'CNCフライス盤 #3で冷却液ポンプの異音が発生しています。すぐに点検が必要です。',
        type: 'error',
      ...
      },
      {
        id: 'notif-002',
        title: '保守期限間近',
        message: 'プレス機 #7の定期保守が明日期限です。作業の準備をお願いします。',
        type: 'warning',
      ...
      },
      {
        id: 'notif-003',
        title: '作業完了',
        message: 'コンベア #2のベルト交換作業が完了しました。動作確認も実施済みです。',
        type: 'success',
      ...
      },
      {
        id: 'notif-004',
        title: '新規作業指示',
        message: '溶接機 #5の電源ケーブル点検が割り当てられました。優先度は中程度です。',
        type: 'info',
      ...
      },
      {
        id: 'notif-005',
        title: 'システム更新',
        message: 'SkillMaintシステムがv2.1.0にアップデートされました。新機能をご確認ください。',
        type: 'info',
      ...
      },
      {
        id: 'notif-006',
        title: '資格期限警告',
        message: '田中太郎さんの第二種電気工事士資格が3月20日に期限切れとなります。',
        type: 'warning',
      ...
      },
      {
        id: 'notif-009',
        title: '保守完了',
        message: '油圧ポンプ #2の定期保守が完了しました。次回は2025年3月予定です。',
        type: 'success',
      ...
      },
      {
        id: 'notif-011',
        title: '部品在庫不足',
        message: 'ベルト交換用部品の在庫が少なくなっています。発注をお願いします。',
        type: 'warning',
          ...
          <CardHeader className="flex-shrink-0 border-b border-gray-200/50 p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <CardTitle className="text-lg font-bold text-gray-900">通知</CardTitle>
                {unreadCount > 0 && (
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-2 mb-1">
                              ...
                              {notification.priority !== 'low' && (
                                <Badge className={`text-xs flex-shrink-0 font-semibold ${getPriorityBadgeColor(notification.priority)}`}>
