                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {selectedInspection.template.estimatedTime}分
                      </p>
                    </div>
                  </div>
                ...
                {selectedInspection.template.requiredTools.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedInspection.template.requiredTools.map(
                        (tool, index) => (
                          <Badge
                            key={index}
                            variant="outline"
                ...
                {selectedInspection.template.checkItems.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-4">
                      {selectedInspection.template.checkItems.map(
                        (checkItem) => (
                          <div
                            key={checkItem.id}
